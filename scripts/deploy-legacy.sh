...
# T3 Turbo Unified Deployment Script
...
# Show usage
show_usage() {
    echo -e "${PURPLE}🚀 T3 Turbo Unified Deployment Script${NC}"
    ...
    echo "  ./scripts/deploy-unified.sh web:tunnel    # Web with tunnel"
    echo "  ./scripts/deploy-unified.sh mobile:tunnel # Mobile with tunnel"
    echo "  ./scripts/deploy-unified.sh all:web       # Complete web deployment"
}
